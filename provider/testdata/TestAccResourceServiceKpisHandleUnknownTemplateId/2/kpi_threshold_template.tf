resource "itsi_kpi_threshold_template" "test_kpis_kpi_threshold_template_3" {
  title                                 = "TestAcc_ResourceServiceKpisHandleUnknownTemplateId_stdev_test_linked_kpi_threshold_template_3"
  description                           = "stdev"
...
resource "itsi_kpi_threshold_template" "test_kpis_static_2" {
  adaptive_thresholding_training_window = "-7d"
  adaptive_thresholds_is_enabled        = false
  description                           = "kpi_threshold_template_static"
  sec_grp                               = "default_itsi_security_group"
  time_variate_thresholds               = true
  title                                 = "TestAcc_ResourceServiceKpisHandleUnknownTemplateId_static_kpi_threshold_template_1"
  time_variate_thresholds_specification {
    policies {
      policy_name = "default_policy"
      policy_type = "static"
